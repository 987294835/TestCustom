	...
	<div class="tcs-flex-row">
		...
		<div class="tcs-sidebar">
			...
			<div class="tcs-left-nav">
				<ul>
					<li>
							<a href="home.jsp" ><i class="fa fa-home fa-fw"></i>首 页</a>
						</li>
						<li>
							<a href="Show_All.do" class="active"><i class="fa fa-database fa-fw"></i>题库</a>
						</li>
						<li>
			...
			<div class="tcs-content col-1 light-gray-bg">
				...
				<div class="tcs-top-nav-container">
					<div class="row line-height-50">
						...
						<ul>
							<li>
								<a class="active margin-right-25" style="border: none;">题库</a>
							</li>
							<li>
								<a href="toAdd.do">+题目</a>
							</li>
						...
						<div class="panel panel-default table-responsive">
							<table class="table table-striped table-bordered tcs-tests-table">
								<thead>
									<tr>
										<td>
											<a href="" class="white-text tcs-sort-by">题目<span
												class="caret"></span> </a>
										</td>
										<td>
											<a href="" class="white-text tcs-sort-by">类型<span
												class="caret"></span> </a>
										</td>
										<td>
											<a href="" class="white-text tcs-sort-by">从属<span
												class="caret"></span> </a>
										</td>
										<td>
											<a href="" class="white-text tcs-sort-by">背景<span
												class="caret"></span> </a>
										</td>
										<!-- <td>Edit</td>
									<td>Delete</td> -->
                 ...
                 <TD height="30">填空题</TD>	                 
						...
						<p class="page">
							...
							<c:choose>
								...
								<c:otherwise>
									<span><a href="mqforpage.do?currPage=${pc.nextPage }">下一页</a>
									</span>
									<span><a href="mqforpage.do?currPage=${pc.totalPages }">尾页</a>
									</span>
								</c:otherwise>
							</c:choose>
							<!--    选择框做法 -->
